...
# Base class for dataset cleaners
# - Clean text: if is a string.
# - Clean words: if is a list of words.
...
class DatasetCleanerManager:
    # As __init__ parameter dataset_cleaners is a dict because is easier to define in Hydra
