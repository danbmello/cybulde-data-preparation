...
class DataProcessingConfig:
    ...
    dvc_remote_repo: str = "https://github.com/danbmello/cybulde-data.git"
    dvc_data_folder: str = "data/raw"
    github_user_name: str = "danbmello"
    github_access_token_secret_id: str = "cybulde-data-github-access-token"

    # For gcp_utils.access_secret_version() -> Create infrastructure/gcp_schema.py -> Call it here
